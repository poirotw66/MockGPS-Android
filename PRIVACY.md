...
Mock GPS stores favorites, route history, app settings, and the last successfully active coordinate only on the device. It does not include analytics, advertising SDKs, accounts, or a backend.
